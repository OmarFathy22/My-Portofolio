      ...
      ">
        <form ref={form} onSubmit={handleSubmit(HandleSubmit)}>
          <div className="flex sm-md:flex-col sm-md:gap-[20px]  w-full">
            ...
            <p className="text-red-500 font-medium"> * {errors.name?.message.toString()}</p>
          )}
            ...
            <p className="text-red-500 font-medium">* {errors.email?.message.toString()}</p>
          )}
        ...
        <div className="flex flex-col gap-[30px] items-center justify-center">
          ...
          <h3 data-aos="fade-right" className="text-[var(--silver)] text-[20px]">Egypt</h3>
          <h1 data-aos="fade-down" className="text-white text-[25px]">
            <FaMobileAlt />
          </h1>
          <h3 data-aos="fade-down" className="text-[var(--silver)] text-[20px]">+20 1064547214</h3>
