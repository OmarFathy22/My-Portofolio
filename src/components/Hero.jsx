      ...
      <div className="HeroRight  flex justify-center flex-1">
        <div className="h-full w-full flex flex-col gap-[30px] justify-center items-center">
          ...
          <a
            href={my_cv}
            download
            className="shadow-[0_1px_10px_rgba(8,_112,_184,_0.3)] shadow-orange-500 text-white border-[1px] border-orange-500 rounded-full p-4 px-14 downloadBtnHover transition-all mt-[50px] sm:mt-[10px]"
          >
            Download CV
          </a>
