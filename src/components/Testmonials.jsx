...
function Testmonials() {
  ...
  if (loading)
    return (
      <div className="min-h-[63.5vh]  mt-[10vh] pt-[10vh] w-[100vw] flex justify-center flex-col items-center text-white  ">
        <svg
          aria-hidden="true"
  ...
  return (
    <div className="my-[100px]">
      <Helmet>
        <meta
          name="Description"
          content="On this page You will find what people say about me and my work"
        />
      ...
      <div className="w-[80%] mx-auto  ">
        <Slider {...settings}>
          {testimonials?.map((item, index) => (
            <div
              key={index}
              className="   mx-auto gap-[50px] !w-[70%] !flex flex-col justify-center items-center"
            >
              <h3
                data-aos="zoom-in"
              ...
              <div className="flex flex-col justify-center items-center gap-[5px] ">
                ...
                >
                  <img
                    src={
                      item?.imageUrl ||
                      "https://res.cloudinary.com/dqhdokahr/image/upload/v1691835172/my-portfolio/anoni_pdh2qo.png"
                    }
                    alt="image"
                ...
                <div>
                  <h1
                    data-aos="fade-left"
                    className="text-white text-[22px] font-medium text-center capitalize"
                  >
                    {item?.name}
                  </h1>
                  <h1
      ...
      <div className="w-full flex flex-col gap-3 justify-center items-center">
        ...
        <p className="text-white text-center px-3">
          You are welcome to provide your Impression about me, and it will be
