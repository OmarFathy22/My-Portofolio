  ...
  return (
    <div className='flex sm:flex-col  justify-center items-center h-[100vh]  gap-[100px]'>
      ...
      <section data-aos="fade-down-left" className='sm:flex sm:flex-col sm:items-center  sm-justify-center px-[10%]'>
        ...
        <button data-aos="zoom-in-up" className='sm:mb-[100px] !z-[-1]  text-white border-[1px] border-[var(--primaryColor)] rounded-full p-4 px-14 hover:bg-[var(--primaryColor)] transition-all mt-[50px]'>Hire Me</button>
      </section>
    </div>
  )
}
